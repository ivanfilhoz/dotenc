...
export const getDefaultEditor = async () => {
	...
	throw new Error(
		'No text editor found. Please set the EDITOR environment variable, configure an editor using "safe-env set-editor", or install a text editor (e.g., nano, vim, or notepad).',
	)
}
