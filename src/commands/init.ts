...
export const initCommand = async (environmentArg: string) => {
	...
	console.log(
		`1. Use "npx safe-env edit -e ${environment}" to securely edit your safe environment variables.`,
	)
	console.log(
		`2. Use "npx safe-env run -e ${environment} <command> [args...]" to run your application.`,
	)
	console.log(
		'3. Use "npx safe-env init -e [environment]" to initialize a new environment.',
	)
	console.log(
